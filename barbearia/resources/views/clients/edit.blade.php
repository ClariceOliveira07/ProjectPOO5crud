    ...
    <div class="flex-1 p-6">
        <div class="flex justify-between items-center mb-6">
            <div>
                ...
                <p class="text-sm text-gray-500">Modificar detalhes do cliente selecionado.</p>
            </div>
        ...
        <div class="flex justify-center mt-8">
            <div class="w-full max-w-xl bg-white border border-gray-200 rounded-md overflow-hidden shadow-sm">
                <div class="bg-[#fef08a] p-4 border-b border-gray-200">
                    <h2 class="font-bold text-yellow-900">Editar Cliente</h2>
                </div>
                
                <form action="{{ route('clients.update', $client->id) }}" method="POST" class="p-4 flex flex-col gap-4">
                    @csrf
                    @method('PUT')

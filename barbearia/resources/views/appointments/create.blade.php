    ...
    <div class="flex-1 p-6">
        ...
        <div class="flex justify-between items-center mb-6">
            <div>
                ...
                <p class="text-sm text-gray-500">Marcar um novo horário para atendimento.</p>
            </div>
        ...
        <div class="flex justify-center mt-6">
            <div class="w-full max-w-xl bg-white border border-gray-200 rounded-md overflow-hidden shadow-sm">
                ...
                <div class="bg-[#e9d5ff] p-4 border-b border-gray-200">
                    <h2 class="font-bold text-purple-900">Novo Agendamento</h2>
                </div>

                <form action="{{ route('appointments.store') }}" method="POST" class="p-4 flex flex-col gap-4">
                    @csrf
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="date" name="data_agenda" id="data_agenda" value="{{ old('data_agenda') }}" 
                        ...
                        <div>
                            ...
                            <input type="time" name="hora_agenda" id="hora_agenda" value="{{ old('hora_agenda') }}" 
                                   class="w-full text-sm p-2 border border-gray-300 rounded-md bg-gray-50 focus:bg-white focus:outline-none">
